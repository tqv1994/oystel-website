<script lang="ts" context="module">
  ...
  import homePageStore from '$lib/stores/page/home';
...
import { getSessionCookieFromRequest } from '$lib/session';
  ...
  export let itemsCuratedForYou: ExperienceModel[] = [];
  export let itemsFromOurAdvisor: any[] = [];
  export let itemsFeaturedDrop: DropModel[];
            ...
            <div class="light text-box">
              <LayoutGrid class="pb-0">
                <Cell spanDevices={{ desktop: 12, tablet: 8, phone: 4 }}
                  ><h1
                    class="mt-0 mb-0 m-pb-0 m-mb-25 m-block"
                  >
    ...
    <section class="has-padding m-pt-40 m-pb-70" id="featured-drops">
      ...
      <LayoutGrid class="pt-0">
        <Cell spanDevices={{ desktop: 5, tablet: 8, phone: 4 }} class="m-mb-45">
          {#if itemsFeaturedDrop && itemsFeaturedDrop.length > 0}
        ...
        >
          {#if itemsFeaturedDrop && itemsFeaturedDrop.length > 1}
    ...
    >
      <div class="content-wrap">
        <LayoutGrid>
          ...
          >
            <h3 class="d-mb-100 d-mt-145 m-mt-40 m-mb-40">
            ...
            <h5 class="mt-0">Become an Oysteo Member now</h5>
          ...
          {#if itemsCuratedForYou.length > 0}
            <div class="item-experience featured">
                <div class="thumbnail dark">
                  ...
                  <div class="caption text-left pl-25 pr-25">
                ...
                {#if index > 0}
                  <Cell spanDevices={{ desktop: 6, phone: 2 }}>
                      <div class="item-experience">
                        ...
                        <a href={item.link}>
                          <p class="text-eyebrow d-mt-25 m-mt-20">
                            Experience
                          </p>
                          <h4 class="text-h2 title mt-25 mb-0 pb-20">
                            {item.title}
                          </h4>
            ...
            <Cell spanDevices={{ desktop: 3, tablet: 4, phone: 2 }}>
              <div class="item-experience">
                  ...
                  <a href={item.link}>
                    ...
                    <h4 class="text-h2 mt-25 mb-40 title">
