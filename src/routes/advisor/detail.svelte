      ...
      <div class="content-wrap">
        <div class="container">
          ...
          >
            ...
            <p class="mt-0 mb-45 description">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce ac
              volutpat neque. Suspendisse varius vitae sem in elementum.
            </p>
        ...
        <LayoutGrid class="p-0 d-pl-115 d-pr-115 t-pl-0 t-pr-0">
          ...
          <Cell spanDevices={{ desktop: 6, tablet: 8, phone: 4 }}>
            <div class="destinations-wrap">
              ...
              <LayoutGrid class="p-0">
                <Cell spanDevices={{ desktop: 6, tablet: 4, phone: 2 }}>
                  <div class="mb-30">
                    <h5 class="mb-15 mt-0">Asia</h5>
                    <p class="mb-10 mt-0">Indonesia</p>
                    <p class="m-0">Maldives</p>
                  </div>
                  <div class="mb-30">
                    <h5 class="mb-15 mt-0">South America</h5>
                    <p class="mb-10 mt-0">Brazil</p>
                    <p class="m-0">Chile</p>
                  </div>
                  <div class="mb-0">
                    <h5 class="mb-15 mt-0">North America</h5>
                    <p class="m-0">Saint Barthélemy</p>
                  </div>
                </Cell>
                <Cell spanDevices={{ desktop: 6, tablet: 4, phone: 2 }}>
                  <div class="mb-0">
                    <h5 class="mb-15 mt-0">Europe</h5>
                    <p class="mb-10 mt-0">France</p>
                    <p class="mb-10 mt-0">Greece</p>
                    <p class="mb-10 mt-0">Italy</p>
                    <p class="mb-10 mt-0">Switzerland</p>
                    <p class="mb-10 mt-0">Spain</p>
                    <p class="mb-10 mt-0">United Kingdom</p>
                  </div>
                </Cell>
              </LayoutGrid>
            </div>
                    ...
                    <div class="trip-item">
                      ...
                      <LayoutGrid class="p-0">
                        <Cell spanDevices={{ desktop: 12, phone: 4, tablet: 8 }}
                          ><p class="text-eyebrow text-left">Italy</p></Cell
                        >
                      </LayoutGrid>
                      <div class="divider" />
                ...
                <Cell spanDevices={{ desktop: 6, tablet: 4, phone: 2 }}>
                  <a href="/experiences-listing/detail">
                    <div class="trip-item">
                      ...
                      <LayoutGrid class="p-0">
                        <Cell spanDevices={{ desktop: 12, phone: 4, tablet: 8 }}
                          ><p class="text-eyebrow text-left">England</p></Cell
                        >
                      </LayoutGrid>
                      <div class="divider" />
                ...
                <Cell spanDevices={{ desktop: 6, tablet: 4, phone: 2 }}>
                  <a href="/experiences-listing/detail">
                    <div class="trip-item">
                      ...
                      <LayoutGrid class="p-0">
                        <Cell spanDevices={{ desktop: 12, phone: 4, tablet: 8 }}
                          ><p class="text-eyebrow text-left">Indonesia</p></Cell
                        >
                      </LayoutGrid>
                      <div class="divider" />
                ...
                <Cell spanDevices={{ desktop: 6, tablet: 4, phone: 2 }}>
                  <a href="/experiences-listing/detail">
                    <div class="trip-item">
                      ...
                      <LayoutGrid class="p-0">
                        <Cell spanDevices={{ desktop: 12, phone: 4, tablet: 8 }}
                          ><p class="text-eyebrow text-left">Greece</p></Cell
                        >
                      </LayoutGrid>
                      <div class="divider" />
                ...
                <Cell spanDevices={{ desktop: 6, tablet: 4, phone: 2 }}>
                  <a href="/experiences-listing/detail">
                    <div class="trip-item">
                      ...
                      <LayoutGrid class="p-0">
                        <Cell spanDevices={{ desktop: 12, phone: 4, tablet: 8 }}
                          ><p class="text-eyebrow text-left">Scotland</p></Cell
                        >
                      </LayoutGrid>
                      <div class="divider" />
            ...
            <div class="d-pt-80 m-pt-20 qualifications-wrap">
              ...
              <p class="text-content mt-0">French, English, Italian</p>
            </div>
          </Cell>
        </LayoutGrid>
      </div>
