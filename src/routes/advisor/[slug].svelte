              ...
              <Cell spanDevices={{ desktop: 6, tablet: 8, phone: 4 }}>
                    ...
                    {#if advisor.destinationType1 || advisor.destinationType2}
                      <Cell spanDevices={{ desktop: 6, tablet: 4, phone: 2 }}>
                          {#if advisor.destinationType1}
                            <div class="mb-30">
                              <h5 class="mb-10 mt-0">{advisor.destinationType1.name}</h5>
                          ...
                          {#if advisor.destinationType2}
                            <div class="mb-0">
                              <h5 class="mb-10 mt-0">{advisor.destinationType2.name}</h5>
                      ...
                      {#if advisor.destinationType3}
                        <Cell spanDevices={{ desktop: 6, tablet: 4, phone: 2 }}>
                              <div
                                class="mb-0"
                              >
                                <h5 class="mb-15 mt-0">{advisor.destinationType3.name}</h5>
                ...
                <div class="d-pt-80 m-pt-20 qualifications-wrap">
                  ...
                  <p class="text-content mt-0 mb-55">
                    {advisor.speciality1?.name || ''}{#if advisor.speciality2},
                          {advisor.speciality2?.name}
                        {/if}{#if advisor.speciality3},
                          {advisor.speciality3?.name}
                        {/if}
                  </p>
                  <p class="title mt-0 mb-30">Languages</p>
                  <p class="text-content mt-0">
                    {advisor.language1?.name || ''}{#if advisor.language2},
                          {advisor.language2?.name}
                        {/if}{#if advisor.language3},
