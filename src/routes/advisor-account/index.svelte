...
<LayoutGrid class="p-0">
  ...
  <Cell class="personal-info" spanDevices={{ desktop: 8, phone: 4, tablet: 8 }}>
    ...
    {#if !isEditProfile}
      ...
      <LayoutGrid class="p-0 pb-15">
        <Cell span="12"><h1 class="mt-0 mb-10">Mrs. Jannice Wohl</h1></Cell>
      </LayoutGrid>
      <LayoutGrid class="p-0 pb-15">
      ...
      <LayoutGrid class="p-0 pb-15">
        ...
        >
        <Cell spanDevices={{ desktop: 9, phone: 4, tablet: 8 }}>NY, USA</Cell>
      </LayoutGrid>
    {/if}
  </Cell>
</LayoutGrid>
<LayoutGrid class="p-0 pt-30">
  <Cell span="12">
    <div class="travel-detais">
      ...
      <LayoutGrid class="p-0 pb-15">
        <Cell span="12"><h5 class="font-weight-bold">Specialties</h5></Cell>
      </LayoutGrid>
      <LayoutGrid class="p-0 pb-15">
        <Cell span="12"
