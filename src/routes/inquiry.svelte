        ...
        <div class="content-wrap">
            <div class="container">
                <div class="text-center mb-45">
                    <div class="logo d-mb-120 m-mb-45 "><img src="/img/logo.svg"/></div>
                    <h1 class="mt-0 m-mb-65">How can we accommodate you?</h1>
                ...
                <div class="form-control text-center mb-20 group-button">
                    <Button variant="outlined" class="d-mr-30 t-mr-30 m-mb-15"><Label>Previous Question</Label></Button>
                    <Button variant="outlined" class="t-mb-15"><Label>Next Question</Label></Button>
                </div>
                        ...
                        <div class="container">
                            <div class="line-steps">
                                {#each stepItems as item}
                                    <div class="item-{item} step {item==7?'active':''}"><span class="text-h5">{item} OF 20</span></div>
                                {/each}
                            </div>
                        </div>
                    </div>
                ...
                <IconButton class="d-none t-none m-block btn-close">
                    <Icon component={Svg} viewBox="0 0 18.858 18.858">
                        <g id="Icon_-_Close" data-name="Icon - Close" transform="translate(-331.071 -23.571)">
                            ...
                            <path id="Line-2" data-name="Line" d="M0,17,9,8.5,18,0" transform="translate(349 24) rotate(90)" fill="none" stroke="#000" stroke-width="1.25"/>
                        </g>
                    </Icon>
                </IconButton>
            </div>
