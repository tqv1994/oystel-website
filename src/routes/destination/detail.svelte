              ...
              <div class="experience-detail-slides">
                <OyCarousel perPage={{ 800: 1 }} draggable={false}>
                  ...
                  <div
                    ...
                    style="background-image: url(/img/experiences/detail.jpg)"
                  />
                  <div
                    class="slide-content slide-item"
                    style="background-image: url(/img/experiences/detail.jpg)"
        ...
        <LayoutGrid class="p-0">
          ...
          <Cell spanDevices={{ desktop: 7, tablet: 8, phone: 4 }}>
            <p class="mt-5">
              ...
              amet ligula at magna consectetur dignissim at ut tellus. Maecenas
              dignissim at arcu ac auctor. Phasellus a nulla in nulla hendrerit
              pellentesque. Morbi eu fringilla nunc. Pellentesque ultricies
              sodales arcu, a euismod mauris ornare at. Quisque bibendum lorem
              enim, vel luctus nibh pretium nec. Nullam commodo lectus id neque
              rhoncus sagittis. Mauris condimentum erat sed nulla porttitor
              commodo. Aliquam non quam vitae velit ullamcorper aliquam.
              Suspendisse et viverra ipsum.
            </p>
            <p>
              Aenean iaculis condimentum nisl non dignissim. Quisque ac pulvinar
              lectus, at laoreet nunc. Quisque ante diam, egestas quis
              condimentum sit amet, auctor eu dolor. Curabitur imperdiet
              elementum urna eget facilisis. Fusce luctus gravida tortor, eget
              elementum libero lobortis pulvinar. Suspendisse at varius tellus.
              Etiam eget turpis quis ante lacinia viverra lobortis id purus.
              Aenean at mi nec lectus tristique tempus. Sed luctus mi quis est
              pharetra consectetur. Fusce faucibus commodo augue, sed
              sollicitudin ipsum lobortis in. Duis non orci commodo massa
              vulputate sollicitudin.
            </p>
            <p>
              Fusce euismod, lorem quis dignissim mollis, tellus tellus feugiat
              diam, sit amet sollicitudin nulla velit sed nisi. In ac venenatis
              turpis, id aliquet metus. Nunc ex justo, cursus a nibh quis,
              euismod tempus nulla. Pellentesque vel dui in nulla semper
              ullamcorper. Vivamus viverra velit id vehicula accumsan.
              Vestibulum sed leo nulla. Donec tempor tincidunt ligula, non
              volutpat purus gravida eu. Sed vitae quam vel arcu porttitor
              aliquet nec a ligula. Quisque ut laoreet metus, porta accumsan
              massa.
            </p>
            <p>
              Vestibulum ante ipsum primis in faucibus orci luctus et ultrices
              posuere cubilia curae; Nam ac egestas ex, vel vulputate nunc.
              Praesent venenatis suscipit augue nec facilisis. Morbi ullamcorper
              enim ullamcorper, porttitor neque eu, laoreet erat.
            </p>
            <p>
              Integer ornare sem ut libero consectetur sagittis. Duis id commodo
              ante, vitae vestibulum mauris. Donec volutpat hendrerit erat non
              semper. Praesent elit lacus, feugiat quis erat.
            </p>
          </Cell>
        </LayoutGrid>
      </div>
