              ...
              <LayoutGrid class="p-0 m-none">
                <Cell spanDevices={{ desktop: 6, tablet: 8, phone: 4 }}>
                  <TabBar {tabs} let:tab bind:active={activeTab}>
                    ...
                    <Tab {tab}>
                      <Label class="text-h2">{tab.name}</Label>
                    </Tab>
                  </TabBar>
                </Cell>
                <Cell
              ...
              <LayoutGrid class="p-0">
                {#each destination.experiences as item}
                  <Cell spanDevices={{ desktop: 3, phone: 2, tablet: 4 }}>
                    <Item pathPrefix="experience" bind:item on:likeItem={likeExperience} />
                  </Cell>
                {/each}
              </LayoutGrid>
            </div>
...
<style lang="scss" global>
  ...
  .page-destination-detail {
    ...
    .destination-detail .header-title .btn-favorite {
      position: relative;
      .like {
        display: block;
      }
    ...
    .destination-detail .header-title .btn-favorite.liked {
      .liked {
        display: block;
      }
      .like {
    ...
    .experience-detail-slides .dots {
      display: none;
    }

    .experience-detail-slides .carousel,
    .experience-detail-slides .slides,
    .experience-detail-slides .slides div {
      height: 90vh;
      @include mobile{
        height: 0px;
    ...
    .experience-detail-slides .slide-item {
      width: 100%;
      height: 100%;
