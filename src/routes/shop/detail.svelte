                ...
                <LayoutGrid class="p-0">
                    <Cell spanDevices={{desktop: 7, tablet: 8, phone: 4}} class="content-left">
                        <div class="get-the-look-item mb-30">
                            ...
                            <LayoutGrid class="p-0">
                                ...
                                <Cell spanDevices={{desktop: 6, tablet: 4, phone: 2}} class="text-right">
                        ...
                        <div class="d-pl-115">
                            ...
                            <div class="text-description-wrap">
                                <p class="m-0">The Bahamas offers the novelty of island culture, natural sights, gorgeous beaches, animal friends, and nightlife aplenty.  Whether you’re shopping the straw markets in Nassau, getting your festival on at Junkanoo, or letting it ride amidst the tables in Atlantis, you’re bound to be bit by the island vibe and leave ready to return soon. </p>
                            </div>
                        </div>
                    </Cell>
                    <Cell spanDevices={{desktop: 5, tablet: 8, phone: 4}} class="content-right">
                        <div class="header-title d-pt-120 d-pb-100 d-pl-120 t-pt-60 t-pb-50 t-pl-60">
                                ...
                                <Cell spanDevices={{desktop: 6, tablet: 4, phone: 2}} class="text-right">
                                    <IconButton class="mt--15">
                                        <Icon component={Svg} viewBox="0 0 16.833 24.384">
                                            <g id="Group_440" data-name="Group 440" transform="translate(-1661.127 -152.323)">
                            ...
                            <p class="text-input">Curated by: Aureta Thomollari  |  Oysteo Partner</p>
                            <Button variant="outlined" class="t-block m-none" on:click={()=>{openQuickShopModal = true}}><label>Quick Shop the Edit</label></Button>
                        </div>
                    </Cell>
                </LayoutGrid>
            </div>
                        ...
                        <Cell spanDevices={{desktop: 3, tablet: 4, phone: 2}}>
                            <a href="#">
                                <div class="product-item">
                                    ...
                                    <div class="divider d-pb-30 t-pb-30 m-pb-25" ></div>
                                    <h4 class="text-h2 mt-0 d-mb-30 t-mb-30 m-mb-25 title">
                                        Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                                    </h4>
                                    <p class="mt-0 mb-0 t-block m-none">Curated by: Elise Cook  |  Oysteo Partner</p>
                                </div>
                            </a>
                        </Cell>
                        <Cell spanDevices={{desktop: 3, tablet: 4, phone: 2}}>
                            <a href="#">
                                <div class="product-item">
                                    ...
                                    <p class="mt-0 mb-0 t-block m-none">Curated by: Pierre Schuester  |  Oysteo Partner</p>
                                </div>
                            </a>
                        </Cell>
                        <Cell spanDevices={{desktop: 3, tablet: 4, phone: 2}}>
                            <a href="#">
                                <div class="product-item">
                                    ...
                                    <p class="mt-0 mb-0 t-block m-none">Curated by: Chelsea Yamase |  Oysteo Partner</p>
                                </div>
                            </a>
                        </Cell>
                        <Cell spanDevices={{desktop: 3, tablet: 4, phone: 2}}>
                            <a href="#">
                                <div class="product-item">
                                    ...
                                    <p class="mt-0 mb-0 t-block m-none">Curated by: Jan Wohl  |  Oysteo Advisor</p>
                                </div>
                            </a>
                        </Cell>
                    </LayoutGrid>
...
<QuickShopModal bind:open={openQuickShopModal} ></QuickShopModal>
<style>
    .header-title{
