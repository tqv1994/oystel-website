...
import { productColourFieldsFragment, productDesignerFieldsFragment, productFieldsFragment, productPatternFieldsFragment, productTypeFieldsFragment, vacationStyleFieldsFragment } from '$lib/store/product';
