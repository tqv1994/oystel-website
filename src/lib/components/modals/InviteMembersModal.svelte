            ...
            <form on:submit={onSubmit} action="javascript:void(0);">
                <DataTable>
                    <Head>
                        <Row>
                            <Cell></Cell>
                            <Cell><Button on:click={addMember}><Icon class="material-icons">add</Icon></Button></Cell>
                        </Row>
                    </Head>
                    <Body>
                            ...
                            <Row>
                                <Cell>
                                    <div class="form-control mb-8">
                                        <Textfield style="width: 100%;" bind:value={item.name} label="Name" type="text"></Textfield>
                                    </div>
                                    <div class="form-control mb-8">
                                        <Textfield style="width: 100%;" bind:value={item.email} label="Email" type="email"></Textfield>
                                    </div>
                                    <div class="form-control mb-8">
                                ...
                                <Cell>
                                    <Button on:click={()=>{removeMember(index)}}><Icon class="material-icons">delete</Icon></Button>
                                </Cell>
                            </Row>
                        {/each}
                    </Body>
...
<script>
    ...
    let roleOptions = [{id: 1, name: 'Rolo 1'},{id: 2, name: 'Rolo 2'}];
