...
<LayoutGrid class="pb-30" >
        ...
        <Button on:click={()=>{openLink('#')}}>
            <div class="wrap-item">
                    <Icon component={Svg} viewBox="0 0 16.47 22.827">
                        <g id="Icon_-_Trips" data-name="Icon - Trips" transform="translate(-240.874 -748)">
                            <g id="Path_322" data-name="Path 322" transform="translate(240.874 748)" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                <path d="M8.235,0A8.235,8.235,0,0,1,16.47,8.235c0,4.548-8.235,14.592-8.235,14.592S0,12.783,0,8.235A8.235,8.235,0,0,1,8.235,0Z" stroke="none"/>
                                <path d="M 8.23486328125 1.500003814697266 C 4.52125358581543 1.500003814697266 1.500002861022949 4.52125358581543 1.500002861022949 8.23486328125 C 1.500002861022949 9.124723434448242 2.000372886657715 11.366623878479 5.351483345031738 16.38340377807617 C 6.40300464630127 17.95758628845215 7.463881492614746 19.39158058166504 8.23497486114502 20.3993091583252 C 9.002147674560547 19.39675521850586 10.05652523040771 17.97159004211426 11.10528373718262 16.40280342102051 C 14.46767330169678 11.37314414978027 14.96972274780273 9.126433372497559 14.96972274780273 8.23486328125 C 14.96972274780273 4.52125358581543 11.94847297668457 1.500003814697266 8.23486328125 1.500003814697266 M 8.23486328125 3.814697265625e-06 C 12.78285312652588 3.814697265625e-06 16.46972274780273 3.686874389648438 16.46972274780273 8.23486328125 C 16.46972274780273 12.78284358978271 8.23486328125 22.8270435333252 8.23486328125 22.8270435333252 C 8.23486328125 22.8270435333252 3.814697265625e-06 12.78284358978271 3.814697265625e-06 8.23486328125 C 3.814697265625e-06 3.686874389648438 3.686873435974121 3.814697265625e-06 8.23486328125 3.814697265625e-06 Z" stroke="none" fill="#000"/>
                            </g>
                            <g id="Path_323" data-name="Path 323" transform="translate(245.874 753)" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                <path d="M3.5,0A3.5,3.5,0,1,1,0,3.5,3.5,3.5,0,0,1,3.5,0Z" stroke="none"/>
                                <path d="M 3.5 1.5 C 2.397200107574463 1.5 1.5 2.397200107574463 1.5 3.5 C 1.5 4.602799892425537 2.397200107574463 5.5 3.5 5.5 C 4.602799892425537 5.5 5.5 4.602799892425537 5.5 3.5 C 5.5 2.397200107574463 4.602799892425537 1.5 3.5 1.5 M 3.5 0 C 5.433000087738037 0 7 1.566999912261963 7 3.5 C 7 5.433000087738037 5.433000087738037 7 3.5 7 C 1.566999912261963 7 0 5.433000087738037 0 3.5 C 0 1.566999912261963 1.566999912261963 0 3.5 0 Z" stroke="none" fill="#000"/>
                            </g>
                        </g>
                    </Icon><br/>
    ...
    <Cell spanDevices={{ phone: 1, desktop: 3, tablet: 2 }} class="text-center">
        <Button on:click={()=>{openLink('#')}}>
            <div class="wrap-item">
                    <Icon component={Svg} viewBox="0 0 25.599 22.563">
                        <g id="Icon_-_Profile" data-name="Icon - Profile" transform="translate(0.721 0.75)">
                            <path id="Path_306" data-name="Path 306" d="M36.155,12.077a5.077,5.077,0,1,0-5.077,5.077A5.092,5.092,0,0,0,36.155,12.077Z" transform="translate(-20.811 -7)" fill="none" stroke="#000" stroke-width="1.5"/>
                            <path id="Path_307" data-name="Path 307" d="M20.5,54.706a7.123,7.123,0,0,1-4.469,0,5.744,5.744,0,0,0-6.267,1.7A9.712,9.712,0,0,0,8.029,62c0,1.053.682,1.285,1.735,1.285h17c1.053,0,1.81-.231,1.81-1.285a9.771,9.771,0,0,0-1.81-5.6A5.756,5.756,0,0,0,20.5,54.706Z" transform="translate(-8 -42.223)" fill="none" stroke="#000" stroke-width="1.5"/>
                        </g>
                    </Icon><br/>
